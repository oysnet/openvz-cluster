...
CzagendaHttpProxy.prototype.installServer = function(callback) {
	...
	this.exec([
					...
					'npm update', 'chmod +x /home/czagenda-http-proxy/startup_scripts/startup-debian', 
					'ln -s /home/czagenda-http-proxy/startup_scripts/startup-debian /etc/init.d/czagenda-http-proxy', 
					'insserv czagenda-http-proxy'].join(' && '), null, function(err, res) {
				if (err) {
