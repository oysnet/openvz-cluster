	...
	async.series({
		...
		'set_ip' : function(callback) {
			...
			if (this.network === Container.NETWORK.VENET) {
				...
				this
						.addIp(this.ip[0], true, logCallback.bind(this, callback,
				...
				async.series([this.start.bind(this), function(callback) {

							this.addIp(this.ip[0], true, logCallback.bind(this,
											callback,
											'Configure veth device with ip '
													+ this.ip[0]));

						}.bind(this), this.stop.bind(this)], logCallback.bind(
								this, callback,
